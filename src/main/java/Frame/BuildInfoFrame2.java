...
public class BuildInfoFrame2 extends JFrame {
    JLabel titleLabel;
    JLabel buildingImageLabel;
    JTextArea descriptionTextArea;
    
    public BuildInfoFrame2(String buildingName) {
        ...
        try {
            URL imageUrl = new URL("https://www.deu.ac.kr/site/resource/www/images/campus-img02.jpg");
